...
*/
     ...
     * @param  image2 the name of the image/picture, e.g., "ball.gif"
     * @throws IllegalArgumentException if the image filename is invalid
     */
    public static void picture(double x, double y, String image2) {
        // BufferedImage image = getImage(filename);
        Image image = getImage(image2);
        double xs = scaleX(x);
        double ys = scaleY(y);
        ...
        if (ws < 0 || hs < 0) throw new IllegalArgumentException("image " + image2 + " is corrupt");
